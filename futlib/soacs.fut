...
let reduce_by_index 'a [m] [n] (dest : *[m]a) (f : a -> a -> a) (ne : a) (is : [n]i32) (as : [n]a) : *[m]a =
  intrinsics.gen_reduce (dest, f, ne, is, as) : *[m]a
...
--
-- **Span:** *O(log(n))*
let stream_red [n] 'a 'b (op: b -> b -> b) (f: []a -> b) (as: [n]a): b =
...
--
-- **Span:** *O(log(n))*
let stream_red_per [n] 'a 'b (op: b -> b -> b) (f: []a -> b) (as: [n]a): b =
...
--
-- **Span:** *O(1)*
let stream_map [n] 'a 'b (f: []a -> []b) (as: [n]a): *[n]b =
...
--
-- **Span:** *O(1)*
let stream_map_per [n] 'a 'b (f: []a -> []b) (as: [n]a): *[n]b =
