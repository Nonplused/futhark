...
bareExp (Lambda tparams params body ret _ loc) =
  Lambda tparams (map barePat params) (bareExp body) ret NoInfo loc
...
bareExp (VConstr0 name _ loc) =
  VConstr0 name NoInfo loc
