...
atomicBinOp :: BinOp -> Maybe (VName -> VName -> Count Bytes Imp.Exp -> Exp -> AtomicOp)
...
data AtomicOp = AtomicAdd VName VName (Count Bytes Imp.Exp) Exp
              | AtomicSMax VName VName (Count Bytes Imp.Exp) Exp
              | AtomicSMin VName VName (Count Bytes Imp.Exp) Exp
              | AtomicUMax VName VName (Count Bytes Imp.Exp) Exp
              | AtomicUMin VName VName (Count Bytes Imp.Exp) Exp
              | AtomicAnd VName VName (Count Bytes Imp.Exp) Exp
              | AtomicOr VName VName (Count Bytes Imp.Exp) Exp
              | AtomicXor VName VName (Count Bytes Imp.Exp) Exp
              | AtomicCmpXchg VName VName (Count Bytes Imp.Exp) Exp Exp
              | AtomicXchg VName VName (Count Bytes Imp.Exp) Exp
              deriving (Show)
